  ...
  render () {
    return (
      <div>
        ...
        <p style={{color: this.state.color, fontSize: "25px", fontFamily: "'Russo One', sans-serif"}}>You voted for Slap, but the majority of the class voted for Cash, so you don't win... sorry</p>
